  ...
  return (
    <div className=''>
      ...
      <footer className="bg-[#f0f9ff] dark:bg-[#0099ff] -mb-20 ">
        <div className="mx-auto text-center w-full max-w-screen-xl">
          ...
          <div className="flex flex-col items-center justify-center px-4 py-6 bg-[#f0f9ff] dark:bg-[#007acc]">
  <span className="text-sm text-blue-900 sm:text-center">
    © 2025 <a href="https://flowbite.com/" className="hover:underline">Your Company</a>. All Rights Reserved.
  </span>
  <div className="flex items-center justify-center space-x-5 mt-4">
    <a
      href="#"
      className="text-blue-900 hover:text-cyan-900 font-bold text-xl dark:hover:text-white flex items-center justify-center"
    >
      <svg
        className="w-6 h-6"
        aria-hidden="true"
    ...
    <a
      href="#"
      className="text-blue-800 hover:text-blue-900 dark:hover:text-white flex items-center justify-center"
    >
      <svg
        className="w-6 h-6"
        aria-hidden="true"
